...
if (!isset($CUSTINFOdisplay)) {
	if (!isset($RS_CUSTINFOdisplay)) {
		$CUSTINFOdisplay = 0;
	} else {
		$CUSTINFOdisplay = $RS_CUSTINFOdisplay;
	}
}
...
if (!isset($parkSTATS)) {
	if (!isset($RS_parkSTATS)) {
		$parkSTATS = '0';
	} else {
		$parkSTATS = $RS_parkSTATS;
	}
}
if (!isset($SLAinSTATS)) {
	if (!isset($RS_SLAinSTATS)) {
		$SLAinSTATS = '0';
	} else {
		$SLAinSTATS = $RS_SLAinSTATS;
	}
}
...
if ($auth) {
	...
	if (strlen($LOGadmin_home_url) > 5) {
		$SSadmin_home_url = $LOGadmin_home_url;
	}
...
$select_list .= "<TR><TD align=right>";
$select_list .= _QXZ("Monitor 1") . ":  </TD><TD align=left><SELECT SIZE=1 NAME=monitor_active ID=monitor_active>";
	...
	<script language="Javascript">
				...
				xmlhttp.onreadystatechange = function() {
					if (xmlhttp.readyState == 4 && xmlhttp.status == 200) {
						...
						if (Xoutput.match(regXFscs)) {
							alert("<?php echo _QXZ("SUCCESS: calling TEST"); ?> " + monitor_phone);
						}
					}
				}
				delete xmlhttp;
		...
		function update_variables(task_option, task_choice, force_reload) {
			...
			if (task_option == 'adastats') {
				if (adastats == '1') {
					adastats = '2';
					document.getElementById("adastatsTXT").innerHTML = "- <?php echo _QXZ("VIEW LESS"); ?>";
				} else {
					adastats = '1';
					document.getElementById("adastatsTXT").innerHTML = "+ <?php echo _QXZ("VIEW MORE"); ?>";
				}
			}
			if (task_option == 'UGdisplay') {
				if (UGdisplay == '1') {
					UGdisplay = '0';
					document.getElementById("UGdisplayTXT").innerHTML = "<?php echo _QXZ("VIEW USER GROUP"); ?>";
				} else {
					UGdisplay = '1';
					document.getElementById("UGdisplayTXT").innerHTML = "<?php echo _QXZ("HIDE USER GROUP"); ?>";
				}
			}
			if (task_option == 'SERVdisplay') {
				if (SERVdisplay == '1') {
					SERVdisplay = '0';
					document.getElementById("SERVdisplayTXT").innerHTML = "<?php echo _QXZ("SHOW SERVER INFO"); ?>";
				} else {
					SERVdisplay = '1';
					document.getElementById("SERVdisplayTXT").innerHTML = "<?php echo _QXZ("HIDE SERVER INFO"); ?>";
				}
			}
			if (task_option == 'CALLSdisplay') {
				if (CALLSdisplay == '1') {
					CALLSdisplay = '0';
					document.getElementById("CALLSdisplayTXT").innerHTML = "<?php echo _QXZ("SHOW WAITING CALLS"); ?>";
				} else {
					CALLSdisplay = '1';
					document.getElementById("CALLSdisplayTXT").innerHTML = "<?php echo _QXZ("HIDE WAITING CALLS"); ?>";
				}
			}
			if (task_option == 'PHONEdisplay') {
				if (PHONEdisplay == '1') {
					PHONEdisplay = '0';
					document.getElementById("PHONEdisplayTXT").innerHTML = "<?php echo _QXZ("SHOW PHONES"); ?>";
				} else {
					PHONEdisplay = '1';
					document.getElementById("PHONEdisplayTXT").innerHTML = "<?php echo _QXZ("HIDE PHONES"); ?>";
				}
			}
			...
			if (task_option == 'ALLINGROUPstats') {
				if (ALLINGROUPstats == '1') {
					ALLINGROUPstats = '0';
					document.getElementById("ALLINGROUPstatsTXT").innerHTML = "<?php echo _QXZ("SHOW IN-GROUP STATS"); ?>";
				} else {
					ALLINGROUPstats = '1';
					document.getElementById("ALLINGROUPstatsTXT").innerHTML = "<?php echo _QXZ("HIDE IN-GROUP STATS"); ?>";
				}
			}
