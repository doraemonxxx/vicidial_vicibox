...
if (isset($_GET["CUSTINFOdisplay"])) {
	$CUSTINFOdisplay = $_GET["CUSTINFOdisplay"];
} elseif (isset($_POST["CUSTINFOdisplay"])) {
	$CUSTINFOdisplay = $_POST["CUSTINFOdisplay"];
}
...
if (isset($_GET["RTajax"])) {
	$RTajax = $_GET["RTajax"];
} elseif (isset($_POST["RTajax"])) {
	$RTajax = $_POST["RTajax"];
}
if (isset($_GET["RTuser"])) {
	$RTuser = $_GET["RTuser"];
} elseif (isset($_POST["RTuser"])) {
	$RTuser = $_POST["RTuser"];
}
if (isset($_GET["RTpass"])) {
	$RTpass = $_GET["RTpass"];
} elseif (isset($_POST["RTpass"])) {
	$RTpass = $_POST["RTpass"];
}
...
if (isset($_GET["ingroup_filter"])) {
	$ingroup_filter = $_GET["ingroup_filter"];
} elseif (isset($_POST["ingroup_filter"])) {
	$ingroup_filter = $_POST["ingroup_filter"];
}
...
if (isset($_GET["mobile_device"])) {
	$mobile_device = $_GET["mobile_device"];
} elseif (isset($_POST["mobile_device"])) {
	$mobile_device = $_POST["mobile_device"];
}
if (isset($_GET["parkSTATS"])) {
	$parkSTATS = $_GET["parkSTATS"];
} elseif (isset($_POST["parkSTATS"])) {
	$parkSTATS = $_POST["parkSTATS"];
}
if (isset($_GET["SLAinSTATS"])) {
	$SLAinSTATS = $_GET["SLAinSTATS"];
} elseif (isset($_POST["SLAinSTATS"])) {
	$SLAinSTATS = $_POST["SLAinSTATS"];
}
...
if (!isset($user_group_filter)) {
	$user_group_filter = array();
}
if (!isset($ingroup_filter)) {
...
if ($CUSTINFOdisplay == 1) {
	$CUSTPHONEdisplay = 0;
}	# only one of these should be on at one time
...
<HEAD>
	...
	if (!$group) {
		...
		if ($CARRIERstats > 0) {
			...
			if ($cache_carrier_stats_realtime > 0) {
				...
				if (strlen($dialstatuses) > 1) {
					...
					$print_ctp = 0;
					while ($print_ctp < $ctp) {
						if (strlen($TFhour_count[$print_ctp]) < 1) {
							$TFhour_count[$print_ctp] = 0;
						}
						if (strlen($SIXhour_count[$print_ctp]) < 1) {
							$SIXhour_count[$print_ctp] = 0;
						}
						if (strlen($ONEhour_count[$print_ctp]) < 1) {
							$ONEhour_count[$print_ctp] = 0;
						}
						if (strlen($FTminute_count[$print_ctp]) < 1) {
							$FTminute_count[$print_ctp] = 0;
						}
						if (strlen($FIVEminute_count[$print_ctp]) < 1) {
							$FIVEminute_count[$print_ctp] = 0;
						}
						if (strlen($ONEminute_count[$print_ctp]) < 1) {
							$ONEminute_count[$print_ctp] = 0;
						}
		...
		##### NOT INBOUND ONLY ###
			...
			if (preg_match('/ALL\-ACTIVE/i', $group_string)) {
				...
				if ((preg_match('/Y/', $with_inbound)) and ($campaign_allow_inbound > 0)) {
					$multi_drop++;
					if ($DB) {
						echo "with_inbound|$with_inbound|$campaign_allow_inbound\n";
					}
			...
			if (($report_display_type != 'WALL_1') and ($report_display_type != 'WALL_2') and ($report_display_type != 'WALL_3') and ($report_display_type != 'WALL_4') and ($report_display_type != 'LIMITED') and (!$mobile_device)) {
				...
				if (1 == count(explode(',', $group_SQL))) {
					echo "<TD ALIGN=RIGHT><font class=\"top_settings_key\"><a href=\"./AST_VICIDIAL_hopperlist.php?group=" . str_replace("'", "", $group_SQL) . "\">" . _QXZ("LEADS IN HOPPER1") . "</a>:</font></TD><TD ALIGN=LEFT><font class=\"top_settings_val\">&nbsp; $VDhop &nbsp; &nbsp; </TD>";
				} else {
					echo "<TD ALIGN=RIGHT><font class=\"top_settings_key\">" . _QXZ("LEADS IN HOPPER2") . ":</font></TD><TD ALIGN=LEFT><font class=\"top_settings_val\">&nbsp; $VDhop &nbsp; &nbsp; </TD>";
				}
		...
		if (($report_display_type != 'WALL_1') and ($report_display_type != 'WALL_2') and ($report_display_type != 'WALL_3') and ($report_display_type != 'WALL_4') and ($report_display_type != 'LIMITED')) {
			...
			if (($RTajax < 1) and ($report_display_type != 'LIMITED')) {
				...
				if ($CALLSdisplay > 0) {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=0&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("HIDE WAITING CALLS") . "</font></a>";
				} else {
				...
				if ($ALLINGROUPstats > 0) {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=0&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("HIDE IN-GROUP STATS") . "</font></a>";
				} else {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=1&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("SHOW IN-GROUP STATS") . "</font></a>";
				}
				if ($PHONEdisplay > 0) {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=0&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("HIDE PHONES") . "</font></a>";
				} else {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=1&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("SHOW PHONES") . "</font></a>";
				}
				if ($CUSTPHONEdisplay > 0) {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=0&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("HIDE CUSTPHONES") . "</font></a>";
				} else {
					echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=1&CUSTINFOdisplay=$CUSTINFOdisplay&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("SHOW CUSTPHONES") . "</font></a>";
				}
				if ($LOGuser_level >= 9) {
					if ($CUSTINFOdisplay > 0) {
						echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=0&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("HIDE FULL CUST INFO") . "</font></a>";
					} else {
						echo " &nbsp; &nbsp; &nbsp; <a href=\"$PHP_SELF?$usergroupQS$groupQS$ingroupQS&RR=$RR&DB=$DB&adastats=$adastats&SIPmonitorLINK=$SIPmonitorLINK&IAXmonitorLINK=$IAXmonitorLINK&usergroup=$usergroup&UGdisplay=$UGdisplay&UidORname=$UidORname&orderby=$orderby&SERVdisplay=$SERVdisplay&CALLSdisplay=$CALLSdisplay&PHONEdisplay=$PHONEdisplay&CUSTPHONEdisplay=$CUSTPHONEdisplay&CUSTINFOdisplay=1&with_inbound=$with_inbound&monitor_active=$monitor_active&monitor_phone=$monitor_phone&ALLINGROUPstats=$ALLINGROUPstats&DROPINGROUPstats=$DROPINGROUPstats&NOLEADSalert=$NOLEADSalert&CARRIERstats=$CARRIERstats&PRESETstats=$PRESETstats&AGENTtimeSTATS=$AGENTtimeSTATS&parkSTATS=$parkSTATS&SLAinSTATS=$SLAinSTATS&INGROUPcolorOVERRIDE=$INGROUPcolorOVERRIDE&droppedOFtotal=$droppedOFtotal&report_display_type=$report_display_type\"><font class=\"top_settings_val\">" . _QXZ("SHOW FULL CUST INFO") . "</font></a>";
					}
				}
			}
	...
	if ($parked_to_print > 0) {
		...
		while ($i < $parked_to_print) {
			...
			if ($LOGadmin_hide_phone_data != '0') {
				$phone_temp = $row[2];
				if ($DB > 0) {
					echo "HIDEPHONEDATA|$row[2]|$LOGadmin_hide_phone_data|\n";
				}
		...
		if (($report_display_type != 'HTML') and ($report_display_type != 'WALL_2') and ($report_display_type != 'WALL_3') and ($report_display_type != 'WALL_4') and ($report_display_type != 'LIMITED')) {
			if ($report_display_type == 'WALL_1') {
				if ($campaign_allow_inbound > 0) {
					echo "$NFB$out_total$NFE " . _QXZ("current active call1") . "&nbsp; &nbsp; &nbsp; \n";
				} else {
				...
				if ($campaign_allow_inbound > 0) {
					echo "$NFB$out_total$NFE " . _QXZ("current active calls2") . "&nbsp; &nbsp; &nbsp; \n";
				} else {
					echo "$NFB$out_total$NFE " . _QXZ("calls being placed") . " &nbsp; &nbsp; &nbsp; \n";
				}
	...
	if (($report_display_type == 'HTML') or ($report_display_type == 'WALL_2') or ($report_display_type == 'LIMITED')) {
		...
		$calls_waiting_td = 'bgcolor="#015b91"';
		$calls_waiting_font = 'style="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		if ($out_live > 0) {
			$calls_waiting_td = 'bgcolor="#FFCCCC"';
			$calls_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($out_live > 4) {
			$calls_waiting_td = 'bgcolor="#FF9999"';
			$calls_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($out_live > 9) {
			$calls_waiting_td = 'bgcolor="#FF6666"';
			$calls_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($out_live > 14) {
			$calls_waiting_td = 'bgcolor="#FF0000"';
			$calls_waiting_font = 'class="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		...
		if ($allow_chats) {
			$chats_waiting_td = 'bgcolor="#015b91"';
			$chats_waiting_font = 'style="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
			if ($chats_waiting > 0) {
				$chats_waiting_td = 'bgcolor="#FFCCCC"';
				$chats_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
			}
			if ($chats_waiting > 4) {
				$chats_waiting_td = 'bgcolor="#FF9999"';
				$chats_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
			}
			if ($chats_waiting > 9) {
				$chats_waiting_td = 'bgcolor="#FF6666"';
				$chats_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
			}
			if ($chats_waiting > 14) {
				$chats_waiting_td = 'bgcolor="#FF0000"';
				$chats_waiting_font = 'class="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
			}
	...
	if ($report_display_type == 'TEXT') {
		...
		$HDcustinfo =		"-------------+----------------------+---------------------+-------+";
		$HTcustinfo =		" " . _QXZ("CUST PHONE", 11) . " | " . _QXZ("SOURCE ID", 20) . " | " . _QXZ("ENTRY DATE", 19) . " | " . _QXZ("STATE", 5) . " |";
		$HDserver_ip =		"-----------------+";
	...
	if (!preg_match("/ALL-/", $LOGallowed_campaigns)) {
		$UgroupSQL = " and vicidial_live_agents.campaign_id IN($group_SQL)";
	} else if ((preg_match('/ALL\-ACTIVE/i', $group_string)) and (strlen($group_SQL) < 3)) {
		$UgroupSQL = '';
	} else {
		$UgroupSQL = " and vicidial_live_agents.campaign_id IN($group_SQL)";
	}
	...
	if (strlen($usergroup) < 1) {
		...
		$usergroupSQL = " and user_group='" . mysqli_real_escape_string($link, $usergroup) . "'";
	}

	if ((preg_match('/ALL\-GROUPS/i', $user_group_string)) and (strlen($user_group_SQL) < 3)) {
		$user_group_filter_SQL = '';
	} else {
		$user_group_filter_SQL = " and vicidial_users.user_group IN($user_group_SQL)";
	}
		...
		while ($j < $talking_to_print) {
			...
			if ($non_latin < 1) {
				...
				if (($report_display_type != 'HTML') and ($report_display_type != 'LIMITED')) {
					...
					while (mb_strlen($extension, 'utf-8') > 14) {
						$extension = mb_substr("$extension", 0, -1, 'utf-8');
					}
				}
			}
				...
				if ($non_latin < 1) {
					...
					if (($report_display_type != 'HTML') and ($report_display_type != 'LIMITED')) {
						while (mb_strlen($user_group, 'utf-8') > 12) {
							$user_group = mb_substr("$user_group", 0, -1, 'utf-8');
						}
					}
				}
			}
			...
			if (($Lstatus == 'INCALL') or ($Lstatus == 'PARK')) {
				if ($comments == 'CHAT') {
					...
					$G = '<SPAN class="orange"><B>';
					$EG = '</B></SPAN>';
					$status = 'EMAIL';
					$tr_class = 'TRorange';
				} else {
					if ($call_time_S >= $rt_report_times["incall_short_time"]) {
						$G = '<SPAN class="thistle"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRthistle';
					}
					if ($call_time_S >= $rt_report_times["incall_medium_time"]) {
						$G = '<SPAN class="violet"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRviolet';
					}
					if ($call_time_S >= $rt_report_times["incall_long_time"]) {
			...
			if ($Lstatus == '3-WAY') {
				if ($call_time_S >= $rt_report_times["threeway_short_time"]) {
					$G = '<SPAN class="lime"><B>';
					$EG = '</B></SPAN>';
					$tr_class = 'TRlime';
				}
			...
			if ($Lstatus == 'DEAD') {
				if ($call_time_S >= 21600) {
					...
					$EG = '</SPAN>';
					$tr_class = 'TRblank';
					if ($call_time_S >= $rt_report_times["dead_short_time"]) {
			...
			if ($Lstatus == 'DISPO') {
				if ($call_time_S >= 21600) {
					...
					$EG = '</SPAN>';
					$tr_class = 'TRblank';
					if ($call_time_S >= $rt_report_times["paused_short_time"]) {
						$G = '<SPAN class="khaki"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRkhaki';
					}
					if ($call_time_S >= $rt_report_times["paused_medium_time"]) {
						$G = '<SPAN class="yellow"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRyellow';
					}
					if ($call_time_S >= $rt_report_times["paused_long_time"]) {
						$G = '<SPAN class="olive"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRolive';
					}
					if ($call_time_S >= $rt_report_times["paused_long_time10"]) {
						$G = '<SPAN class="darkolivegreen"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRdarkolivegreen';
					}
					if ($call_time_S >= $rt_report_times["paused_long_time15"]) {
						$G = '<SPAN class="saddlebrown"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRsaddlebrown';
					}
					if ($call_time_S >= $rt_report_times["pause_limit"]) {
						$G = '<SPAN class="darkred"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRdarkred';
					}
				}
			...
			if ((preg_match("/INCALL|DIAL/i", $status)) or (preg_match("/QUEUE/i", $status))  or (preg_match("/3-WAY/i", $status)) or (preg_match('/PARK/i', $status))) {
				$agent_incall++;
				$agent_total++;
			}
			if (preg_match("/DIAL/i", $status)) {
				$agent_indial++;
			}
			...
			if ((preg_match("/READY/i", $status)) or (preg_match("/CLOSER/i", $status))) {
				if ($RS_agentWAIT == 4) {
					...
					if ($call_time_S >= $rt_report_times["waiting_short_time"]) {
						$G = '<SPAN class="rust"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRrust';
					}
					if ($call_time_S >= $rt_report_times["waiting_medium_time"]) {
						$G = '<SPAN class="blue"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRblue';
					}
					if ($call_time_S >= $rt_report_times["waiting_long_time"]) {
						$G = '<SPAN class="midnightblue"><B>';
						$EG = '</B></SPAN>';
						$tr_class = 'TRmidnightblue';
					}
				} else {
					$G = '<SPAN class="lightblue"><B>';
					$EG = '</B></SPAN>';
			...
			if ($report_display_type == 'TEXT') {
				if ($SIPmonitorLINK > 0) {
					$L = " | <a href=\"sip:0$Lsessionid@$server_ip\">" . _QXZ("LISTEN", 6) . "</a>";
					$R = '';
				}
				if ($IAXmonitorLINK > 0) {
					$L = " | <a href=\"iax:0$Lsessionid@$server_ip\">" . _QXZ("LISTEN", 6) . "</a>";
					$R = '';
				}
				if ($SIPmonitorLINK > 1) {
					$R = " | <a href=\"sip:$Lsessionid@$server_ip\">" . _QXZ("BARGE", 5) . "</a>";
				}
				if ($IAXmonitorLINK > 1) {
				...
				if ((strlen($monitor_phone) > 1) and (preg_match("/MONITOR|BARGE|WHISPER/", $monitor_active)) and (preg_match("/MONITOR/", $RS_ListenBarge))) {
					$L = " | <a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','MONITOR');\">" . _QXZ("LISTEN", 6) . "</a>";
					$R = '';
				}
				if ((strlen($monitor_phone) > 1) and (preg_match("/BARGE|WHISPER/", $monitor_active)) and (preg_match("/BARGE/", $RS_ListenBarge))) {
					$BARGEstage = 'BARGE';
					if ($RS_BargeSwap > 0) {
						$BARGEstage = 'BARGESWAP';
					}
					$R = " | <a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','$BARGEstage');\">" . _QXZ("BARGE", 5) . "</a>";
				}
				if ($SIPmonitorLINK > 1) {
					$R = " | <a href=\"sip:47378218$Lsessionid@$server_ip\">WHISPER</a>";
				}
				if ($IAXmonitorLINK > 1) {
					$R = " | <a href=\"iax:47378218$Lsessionid@$server_ip\">WHISPER</a>";
				}
				...
				if ($CUSTINFOdisplay > 0) {
					$CI = " $G$custphone$EG | $G$cust_source$EG | $G$cust_entrydate$EG | $G$cust_state$EG |";
				} else {
					$CI = "";
				}
				...
				if ($SERVdisplay > 0) {
					$SVD = " $G$server_ip$EG | $G$call_server_ip$EG |";
				} else {
					$SVD = "";
				}
				...
				if ($CM == 'I') {
					...
					if ($ingrp_to_print > 0) {
						...
						if (($INGROUPcolorOVERRIDE > 0) or ($INGROUPcolorOVERRIDE == 'YES')) {
							$ING = '<SPAN class="csc' . $INORcolor . '"><B>';
							$INEG = '</B></SPAN>';
						}
					}
				...
				if (strlen($RS_AGENTstatusTALLY) > 0) {
					...
					if ($ast_to_print > 0) {
						...
						if ($INORcolor > 0) {
							$AST = '<SPAN class="csc' . $INORcolor . '"><B>';
							$ASTG = '</B></SPAN>';
						}
					}
			...
			if (($report_display_type == 'HTML') or ($report_display_type == 'LIMITED')) {
				...
				if ($SIPmonitorLINK > 0) {
					$L = "<td NOWRAP align=center> <a href=\"sip:0$Lsessionid@$server_ip\">" . _QXZ("LISTEN") . "</a></td>";
					$R = '';
				}
				if ($IAXmonitorLINK > 0) {
					$L = "<td NOWRAP align=center> <a href=\"iax:0$Lsessionid@$server_ip\">" . _QXZ("LISTEN") . "</a></td>";
					$R = '';
				}
				if ($SIPmonitorLINK > 1) {
					$R = " <td NOWRAP align=center> <a href=\"sip:$Lsessionid@$server_ip\">" . _QXZ("BARGE") . "</a></td>";
				}
				if ($IAXmonitorLINK > 1) {
					$R = " <td NOWRAP align=center> <a href=\"iax:$Lsessionid@$server_ip\">BARGE</a></td>";
				}
				if ((strlen($monitor_phone) > 1) and (preg_match("/MONITOR|BARGE|WHISPER/", $monitor_active)) and (preg_match("/MONITOR/", $RS_ListenBarge))) {
					$L = "<td NOWRAP align=center> <a href=\"javascript:send_monitor('$Lsessionid','$Lserver_ip','MONITOR');\">" . _QXZ("LISTEN") . "</a></td>";
					$R = '';
				}
				if ((strlen($monitor_phone) > 1) and (preg_match("/BARGE|WHISPER/", $monitor_active)) and (preg_match("/BARGE/", $RS_ListenBarge))) {
					$BARGEstage = 'BARGE';
				...
				if ($SIPmonitorLINK > 1) {
					$R = " </td><td NOWRAP align=center> <a href=\"sip:47378218$Lsessionid@$server_ip\">WHISPER</a></td>";
				}
				if ($IAXmonitorLINK > 1) {
					$R = " </td><td NOWRAP align=center> <a href=\"iax:47378218$Lsessionid@$server_ip\">WHISPER</a></td>";
				}
				if ((strlen($monitor_phone) > 1) and (preg_match("/WHISPER/", $monitor_active)) and (preg_match("/WHISPER/", $RS_ListenBarge))) {
				...
				if ($CUSTPHONEdisplay > 0) {
					$CP = " $G$custphone$EG </td><td NOWRAP align=right>";
				} else {
					$CP = "";
				}

				if ($CUSTINFOdisplay > 0) {
					$CI = " $G$custphone$EG </td><td NOWRAP align=right> $G$cust_source$EG </td><td NOWRAP align=right> $G$cust_entrydate$EG </td><td NOWRAP align=right> $G$cust_state$EG </td><td NOWRAP align=right>";
				} else {
					$CI = "";
				}

				if ($UGdisplay > 0) {
					$UGD = " $G$user_group$EG </td><td NOWRAP align=right>";
				} else {
					$UGD = "";
				}

				if ($SERVdisplay > 0) {
					$SVD = " $G$server_ip$EG </td><td NOWRAP align=right> $G$call_server_ip$EG </td><td NOWRAP align=right>";
				} else {
					$SVD = "";
				}

				if ($PHONEdisplay > 0) {
					$phoneD = "$G$phone$EG </td><td NOWRAP>";
				} else {
					$phoneD = " ";
				}

				if ($agent_pause_codes_active > 0) {
					$pausecodeHTML = "<td bgcolor=white align=center><font class='Hblank'>$pausecode</td>";
				} else {
					$pausecodeHTML = "";
				}
	...
	if (($report_display_type == 'HTML') or ($report_display_type == 'WALL_2') or ($report_display_type == 'LIMITED')) {
		...
		$agents_waiting_td = 'bgcolor="#015b91"';
		$agents_waiting_font = 'style="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		if ($agent_ready > 0) {
			$agents_waiting_td = 'bgcolor="#CCFFCC"';
			$agents_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($agent_ready > 4) {
			$agents_waiting_td = 'bgcolor="#99FF99"';
			$agents_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($agent_ready > 9) {
			$agents_waiting_td = 'bgcolor="#00FF00"';
			$agents_waiting_font = 'style="color: black; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
		if ($agent_ready > 14) {
			$agents_waiting_td = 'bgcolor="#00CC00"';
			$agents_waiting_font = 'class="color: white; font-family: HELVETICA; font-size: 18; font-weight: bold;"';
		}
