...
if (isset($_GET["update_phone_number"])) {
	$update_phone_number = $_GET["update_phone_number"];
} elseif (isset($_POST["update_phone_number"])) {
...
} elseif (isset($_POST["source_id"])) {
	$source_id = $_POST["source_id"];
}
if (isset($_GET["gmt_offset_now"])) {
	$gmt_offset_now = $_GET["gmt_offset_now"];
} elseif (isset($_POST["gmt_offset_now"])) {
	$gmt_offset_now = $_POST["gmt_offset_now"];
}
if (isset($_GET["title"])) {
	$title = $_GET["title"];
...
if (isset($_GET["security_phrase"])) {
	$security_phrase = $_GET["security_phrase"];
} elseif (isset($_POST["security_phrase"])) {
...
if (isset($_GET["dnc_check"])) {
	$dnc_check = $_GET["dnc_check"];
} elseif (isset($_POST["dnc_check"])) {
	$dnc_check = $_POST["dnc_check"];
}
if (isset($_GET["campaign_dnc_check"])) {
	$campaign_dnc_check = $_GET["campaign_dnc_check"];
} elseif (isset($_POST["campaign_dnc_check"])) {
	$campaign_dnc_check = $_POST["campaign_dnc_check"];
}
if (isset($_GET["add_to_hopper"])) {
	$add_to_hopper = $_GET["add_to_hopper"];
} elseif (isset($_POST["add_to_hopper"])) {
	$add_to_hopper = $_POST["add_to_hopper"];
}
if (isset($_GET["hopper_priority"])) {
	$hopper_priority = $_GET["hopper_priority"];
} elseif (isset($_POST["hopper_priority"])) {
	$hopper_priority = $_POST["hopper_priority"];
}
if (isset($_GET["hopper_local_call_time_check"])) {
	$hopper_local_call_time_check = $_GET["hopper_local_call_time_check"];
} elseif (isset($_POST["hopper_local_call_time_check"])) {
	$hopper_local_call_time_check = $_POST["hopper_local_call_time_check"];
}
...
if (isset($_GET["multi_alt_phones"])) {
	$multi_alt_phones = $_GET["multi_alt_phones"];
} elseif (isset($_POST["multi_alt_phones"])) {
	$multi_alt_phones = $_POST["multi_alt_phones"];
}
...
if (isset($_GET["duplicate_check"])) {
	$duplicate_check = $_GET["duplicate_check"];
} elseif (isset($_POST["duplicate_check"])) {
...
} elseif (isset($_POST["search_method"])) {
	$search_method = $_POST["search_method"];
}
if (isset($_GET["insert_if_not_found"])) {
	$insert_if_not_found = $_GET["insert_if_not_found"];
} elseif (isset($_POST["insert_if_not_found"])) {
	$insert_if_not_found = $_POST["insert_if_not_found"];
}
...
if (isset($_GET["user_field"])) {
	$user_field = $_GET["user_field"];
} elseif (isset($_POST["user_field"])) {
...
if (isset($_GET["agent_pass"])) {
	$agent_pass = $_GET["agent_pass"];
} elseif (isset($_POST["agent_pass"])) {
	$agent_pass = $_POST["agent_pass"];
}
if (isset($_GET["agent_user_level"])) {
	$agent_user_level = $_GET["agent_user_level"];
} elseif (isset($_POST["agent_user_level"])) {
	$agent_user_level = $_POST["agent_user_level"];
}
if (isset($_GET["agent_full_name"])) {
	$agent_full_name = $_GET["agent_full_name"];
} elseif (isset($_POST["agent_full_name"])) {
	$agent_full_name = $_POST["agent_full_name"];
}
if (isset($_GET["agent_user_group"])) {
	$agent_user_group = $_GET["agent_user_group"];
} elseif (isset($_POST["agent_user_group"])) {
...
if (isset($_GET["hotkeys_active"])) {
	$hotkeys_active = $_GET["hotkeys_active"];
} elseif (isset($_POST["hotkeys_active"])) {
	$hotkeys_active = $_POST["hotkeys_active"];
}
if (isset($_GET["voicemail_id"])) {
	$voicemail_id = $_GET["voicemail_id"];
} elseif (isset($_POST["voicemail_id"])) {
...
if (isset($_GET["custom_one"])) {
	$custom_one = $_GET["custom_one"];
} elseif (isset($_POST["custom_one"])) {
	$custom_one = $_POST["custom_one"];
}
if (isset($_GET["custom_two"])) {
	$custom_two = $_GET["custom_two"];
} elseif (isset($_POST["custom_two"])) {
	$custom_two = $_POST["custom_two"];
}
if (isset($_GET["custom_three"])) {
	$custom_three = $_GET["custom_three"];
} elseif (isset($_POST["custom_three"])) {
	$custom_three = $_POST["custom_three"];
}
if (isset($_GET["custom_four"])) {
	$custom_four = $_GET["custom_four"];
} elseif (isset($_POST["custom_four"])) {
	$custom_four = $_POST["custom_four"];
}
if (isset($_GET["custom_five"])) {
	$custom_five = $_GET["custom_five"];
} elseif (isset($_POST["custom_five"])) {
...
if (isset($_GET["dialplan_number"])) {
	$dialplan_number = $_GET["dialplan_number"];
} elseif (isset($_POST["dialplan_number"])) {
...
if (isset($_GET["registration_password"])) {
	$registration_password = $_GET["registration_password"];
} elseif (isset($_POST["registration_password"])) {
	$registration_password = $_POST["registration_password"];
}
if (isset($_GET["phone_full_name"])) {
	$phone_full_name = $_GET["phone_full_name"];
} elseif (isset($_POST["phone_full_name"])) {
	$phone_full_name = $_POST["phone_full_name"];
}
...
if (isset($_GET["outbound_cid"])) {
	$outbound_cid = $_GET["outbound_cid"];
} elseif (isset($_POST["outbound_cid"])) {
...
if (isset($_GET["am_message"])) {
	$am_message = $_GET["am_message"];
} elseif (isset($_POST["am_message"])) {
	$am_message = $_POST["am_message"];
}
if (isset($_GET["drop_inbound_group"])) {
	$drop_inbound_group = $_GET["drop_inbound_group"];
} elseif (isset($_POST["drop_inbound_group"])) {
	$drop_inbound_group = $_POST["drop_inbound_group"];
}
if (isset($_GET["web_form_address"])) {
	$web_form_address = $_GET["web_form_address"];
} elseif (isset($_POST["web_form_address"])) {
	$web_form_address = $_POST["web_form_address"];
}
if (isset($_GET["web_form_address_two"])) {
	$web_form_address_two = $_GET["web_form_address_two"];
} elseif (isset($_POST["web_form_address_two"])) {
	$web_form_address_two = $_POST["web_form_address_two"];
}
if (isset($_GET["web_form_address_three"])) {
	$web_form_address_three = $_GET["web_form_address_three"];
} elseif (isset($_POST["web_form_address_three"])) {
	$web_form_address_three = $_POST["web_form_address_three"];
}
if (isset($_GET["reset_list"])) {
	$reset_list = $_GET["reset_list"];
} elseif (isset($_POST["reset_list"])) {
...
if (isset($_GET["delete_leads"])) {
	$delete_leads = $_GET["delete_leads"];
} elseif (isset($_POST["delete_leads"])) {
	$delete_leads = $_POST["delete_leads"];
}
if (isset($_GET["reset_time"])) {
	$reset_time = $_GET["reset_time"];
...
if (isset($_GET["tz_method"])) {
	$tz_method = $_GET["tz_method"];
} elseif (isset($_POST["tz_method"])) {
	$tz_method = $_POST["tz_method"];
}
if (isset($_GET["reset_lead"])) {
	$reset_lead = $_GET["reset_lead"];
} elseif (isset($_POST["reset_lead"])) {
	$reset_lead = $_POST["reset_lead"];
}
if (isset($_GET["usacan_areacode_check"])) {
	$usacan_areacode_check = $_GET["usacan_areacode_check"];
} elseif (isset($_POST["usacan_areacode_check"])) {
	$usacan_areacode_check = $_POST["usacan_areacode_check"];
}
if (isset($_GET["usacan_prefix_check"])) {
	$usacan_prefix_check = $_GET["usacan_prefix_check"];
} elseif (isset($_POST["usacan_prefix_check"])) {
	$usacan_prefix_check = $_POST["usacan_prefix_check"];
}
if (isset($_GET["delete_phone"])) {
	$delete_phone = $_GET["delete_phone"];
} elseif (isset($_POST["delete_phone"])) {
	$delete_phone = $_POST["delete_phone"];
}
if (isset($_GET["alias_id"])) {
	$alias_id = $_GET["alias_id"];
} elseif (isset($_POST["alias_id"])) {
	$alias_id = $_POST["alias_id"];
}
if (isset($_GET["phone_logins"])) {
	$phone_logins = $_GET["phone_logins"];
} elseif (isset($_POST["phone_logins"])) {
	$phone_logins = $_POST["phone_logins"];
}
if (isset($_GET["alias_name"])) {
	$alias_name = $_GET["alias_name"];
} elseif (isset($_POST["alias_name"])) {
	$alias_name = $_POST["alias_name"];
}
if (isset($_GET["delete_alias"])) {
	$delete_alias = $_GET["delete_alias"];
} elseif (isset($_POST["delete_alias"])) {
	$delete_alias = $_POST["delete_alias"];
}
...
if (isset($_GET["callback_status"])) {
	$callback_status = $_GET["callback_status"];
} elseif (isset($_POST["callback_status"])) {
	$callback_status = $_POST["callback_status"];
}
if (isset($_GET["callback_datetime"])) {
	$callback_datetime = $_GET["callback_datetime"];
} elseif (isset($_POST["callback_datetime"])) {
	$callback_datetime = $_POST["callback_datetime"];
}
if (isset($_GET["callback_type"])) {
	$callback_type = $_GET["callback_type"];
} elseif (isset($_POST["callback_type"])) {
	$callback_type = $_POST["callback_type"];
}
if (isset($_GET["callback_user"])) {
	$callback_user = $_GET["callback_user"];
} elseif (isset($_POST["callback_user"])) {
	$callback_user = $_POST["callback_user"];
}
if (isset($_GET["callback_comments"])) {
	$callback_comments = $_GET["callback_comments"];
} elseif (isset($_POST["callback_comments"])) {
	$callback_comments = $_POST["callback_comments"];
}
if (isset($_GET["admin_user_group"])) {
	$admin_user_group = $_GET["admin_user_group"];
} elseif (isset($_POST["admin_user_group"])) {
	$admin_user_group = $_POST["admin_user_group"];
}
if (isset($_GET["datetime_start"])) {
	$datetime_start = $_GET["datetime_start"];
} elseif (isset($_POST["datetime_start"])) {
	$datetime_start = $_POST["datetime_start"];
}
if (isset($_GET["datetime_end"])) {
	$datetime_end = $_GET["datetime_end"];
} elseif (isset($_POST["datetime_end"])) {
	$datetime_end = $_POST["datetime_end"];
}
if (isset($_GET["time_format"])) {
	$time_format = $_GET["time_format"];
} elseif (isset($_POST["time_format"])) {
	$time_format = $_POST["time_format"];
}
if (isset($_GET["group_alias_id"])) {
	$group_alias_id = $_GET["group_alias_id"];
} elseif (isset($_POST["group_alias_id"])) {
	$group_alias_id = $_POST["group_alias_id"];
}
if (isset($_GET["group_alias_name"])) {
	$group_alias_name = $_GET["group_alias_name"];
} elseif (isset($_POST["group_alias_name"])) {
	$group_alias_name = $_POST["group_alias_name"];
}
if (isset($_GET["caller_id_number"])) {
	$caller_id_number = $_GET["caller_id_number"];
} elseif (isset($_POST["caller_id_number"])) {
	$caller_id_number = $_POST["caller_id_number"];
}
if (isset($_GET["caller_id_name"])) {
	$caller_id_name = $_GET["caller_id_name"];
} elseif (isset($_POST["caller_id_name"])) {
...
if (isset($_GET["in_groups"])) {
	$in_groups = $_GET["in_groups"];
} elseif (isset($_POST["in_groups"])) {
	$in_groups = $_POST["in_groups"];
}
if (isset($_GET["did_ids"])) {
	$did_ids = $_GET["did_ids"];
} elseif (isset($_POST["did_ids"])) {
	$did_ids = $_POST["did_ids"];
}
if (isset($_GET["did_patterns"])) {
	$did_patterns = $_GET["did_patterns"];
} elseif (isset($_POST["did_patterns"])) {
	$did_patterns = $_POST["did_patterns"];
}
...
} elseif (isset($_POST["expiration_date"])) {
	$expiration_date = $_POST["expiration_date"];
}
if (isset($_GET["nanpa_ac_prefix_check"])) {
	$nanpa_ac_prefix_check = $_GET["nanpa_ac_prefix_check"];
} elseif (isset($_POST["nanpa_ac_prefix_check"])) {
	$nanpa_ac_prefix_check = $_POST["nanpa_ac_prefix_check"];
}
...
if (isset($_GET["campaign_rank"])) {
	$campaign_rank = $_GET["campaign_rank"];
} elseif (isset($_POST["campaign_rank"])) {
	$campaign_rank = $_POST["campaign_rank"];
}
if (isset($_GET["campaign_grade"])) {
	$campaign_grade = $_GET["campaign_grade"];
} elseif (isset($_POST["campaign_grade"])) {
	$campaign_grade = $_POST["campaign_grade"];
}
if (isset($_GET["local_call_time"])) {
	$local_call_time = $_GET["local_call_time"];
} elseif (isset($_POST["local_call_time"])) {
	$local_call_time = $_POST["local_call_time"];
}
if (isset($_GET["camp_rg_only"])) {
	$camp_rg_only = $_GET["camp_rg_only"];
} elseif (isset($_POST["camp_rg_only"])) {
	$camp_rg_only = $_POST["camp_rg_only"];
}
if (isset($_GET["wrapup_seconds_override"])) {
	$wrapup_seconds_override = $_GET["wrapup_seconds_override"];
} elseif (isset($_POST["wrapup_seconds_override"])) {
	$wrapup_seconds_override = $_POST["wrapup_seconds_override"];
}
if (isset($_GET["entry_list_id"])) {
	$entry_list_id = $_GET["entry_list_id"];
} elseif (isset($_POST["entry_list_id"])) {
	$entry_list_id = $_POST["entry_list_id"];
}
if (isset($_GET["show_sub_status"])) {
	$show_sub_status = $_GET["show_sub_status"];
} elseif (isset($_POST["show_sub_status"])) {
	$show_sub_status = $_POST["show_sub_status"];
}
...
if (isset($_GET["ingroups"])) {
	$ingroups = $_GET["ingroups"];
} elseif (isset($_POST["ingroups"])) {
	$ingroups = $_POST["ingroups"];
}
...
if (isset($_GET["auto_dial_level"])) {
	$auto_dial_level = $_GET["auto_dial_level"];
} elseif (isset($_POST["auto_dial_level"])) {
	$auto_dial_level = $_POST["auto_dial_level"];
}
if (isset($_GET["adaptive_maximum_level"])) {
	$adaptive_maximum_level = $_GET["adaptive_maximum_level"];
} elseif (isset($_POST["adaptive_maximum_level"])) {
	$adaptive_maximum_level = $_POST["adaptive_maximum_level"];
}
if (isset($_GET["campaign_vdad_exten"])) {
	$campaign_vdad_exten = $_GET["campaign_vdad_exten"];
} elseif (isset($_POST["campaign_vdad_exten"])) {
	$campaign_vdad_exten = $_POST["campaign_vdad_exten"];
}
if (isset($_GET["hopper_level"])) {
	$hopper_level = $_GET["hopper_level"];
} elseif (isset($_POST["hopper_level"])) {
	$hopper_level = $_POST["hopper_level"];
}
if (isset($_GET["reset_hopper"])) {
	$reset_hopper = $_GET["reset_hopper"];
} elseif (isset($_POST["reset_hopper"])) {
	$reset_hopper = $_POST["reset_hopper"];
}
...
if (isset($_GET["dial_timeout"])) {
	$dial_timeout = $_GET["dial_timeout"];
} elseif (isset($_POST["dial_timeout"])) {
...
if (isset($_GET["lookup_state"])) {
	$lookup_state = $_GET["lookup_state"];
} elseif (isset($_POST["lookup_state"])) {
	$lookup_state = $_POST["lookup_state"];
}
if (isset($_GET["type"])) {
	$type = $_GET["type"];
...
if (isset($_GET["status_breakdown"])) {
	$status_breakdown = $_GET["status_breakdown"];
} elseif (isset($_POST["status_breakdown"])) {
	$status_breakdown = $_POST["status_breakdown"];
}
if (isset($_GET["show_percentages"])) {
	$show_percentages = $_GET["show_percentages"];
} elseif (isset($_POST["show_percentages"])) {
	$show_percentages = $_POST["show_percentages"];
}
...
if (isset($_GET["force_entry_list_id"])) {
	$force_entry_list_id = $_GET["force_entry_list_id"];
} elseif (isset($_POST["force_entry_list_id"])) {
	$force_entry_list_id = $_POST["force_entry_list_id"];
}
if (isset($_GET["lead_filter_id"])) {
	$lead_filter_id = $_GET["lead_filter_id"];
} elseif (isset($_POST["lead_filter_id"])) {
	$lead_filter_id = $_POST["lead_filter_id"];
}
if (isset($_GET["agent_choose_ingroups"])) {
	$agent_choose_ingroups = $_GET["agent_choose_ingroups"];
} elseif (isset($_POST["agent_choose_ingroups"])) {
	$agent_choose_ingroups = $_POST["agent_choose_ingroups"];
}
if (isset($_GET["agent_choose_blended"])) {
	$agent_choose_blended = $_GET["agent_choose_blended"];
} elseif (isset($_POST["agent_choose_blended"])) {
	$agent_choose_blended = $_POST["agent_choose_blended"];
}
if (isset($_GET["closer_default_blended"])) {
	$closer_default_blended = $_GET["closer_default_blended"];
} elseif (isset($_POST["closer_default_blended"])) {
	$closer_default_blended = $_POST["closer_default_blended"];
}
if (isset($_GET["outbound_alt_cid"])) {
	$outbound_alt_cid = $_GET["outbound_alt_cid"];
} elseif (isset($_POST["outbound_alt_cid"])) {
	$outbound_alt_cid = $_POST["outbound_alt_cid"];
}
if (isset($_GET["phone_ring_timeout"])) {
	$phone_ring_timeout = $_GET["phone_ring_timeout"];
} elseif (isset($_POST["phone_ring_timeout"])) {
	$phone_ring_timeout = $_POST["phone_ring_timeout"];
}
if (isset($_GET["delete_vm_after_email"])) {
	$delete_vm_after_email = $_GET["delete_vm_after_email"];
} elseif (isset($_POST["delete_vm_after_email"])) {
...
if (isset($_GET["did_route"])) {
	$did_route = $_GET["did_route"];
} elseif (isset($_POST["did_route"])) {
	$did_route = $_POST["did_route"];
}
if (isset($_GET["record_call"])) {
	$record_call = $_GET["record_call"];
} elseif (isset($_POST["record_call"])) {
	$record_call = $_POST["record_call"];
}
if (isset($_GET["exten_context"])) {
	$exten_context = $_GET["exten_context"];
} elseif (isset($_POST["exten_context"])) {
	$exten_context = $_POST["exten_context"];
}
if (isset($_GET["voicemail_ext"])) {
	$voicemail_ext = $_GET["voicemail_ext"];
} elseif (isset($_POST["voicemail_ext"])) {
	$voicemail_ext = $_POST["voicemail_ext"];
}
if (isset($_GET["phone_extension"])) {
	$phone_extension = $_GET["phone_extension"];
} elseif (isset($_POST["phone_extension"])) {
	$phone_extension = $_POST["phone_extension"];
}
if (isset($_GET["filter_clean_cid_number"])) {
	$filter_clean_cid_number = $_GET["filter_clean_cid_number"];
} elseif (isset($_POST["filter_clean_cid_number"])) {
	$filter_clean_cid_number = $_POST["filter_clean_cid_number"];
}
if (isset($_GET["ignore_agentdirect"])) {
	$ignore_agentdirect = $_GET["ignore_agentdirect"];
} elseif (isset($_POST["ignore_agentdirect"])) {
	$ignore_agentdirect = $_POST["ignore_agentdirect"];
}
...
if (isset($_GET["cid_group_id"])) {
	$cid_group_id = $_GET["cid_group_id"];
} elseif (isset($_POST["cid_group_id"])) {
	$cid_group_id = $_POST["cid_group_id"];
}
if (isset($_GET["cid_description"])) {
	$cid_description = $_GET["cid_description"];
} elseif (isset($_POST["cid_description"])) {
	$cid_description = $_POST["cid_description"];
}
if (isset($_GET["custom_fields_copy"])) {
	$custom_fields_copy = $_GET["custom_fields_copy"];
} elseif (isset($_POST["custom_fields_copy"])) {
	$custom_fields_copy = $_POST["custom_fields_copy"];
}
...
if (isset($_GET["leads_counts"])) {
	$leads_counts = $_GET["leads_counts"];
} elseif (isset($_POST["leads_counts"])) {
	$leads_counts = $_POST["leads_counts"];
}
if (isset($_GET["remove_from_hopper"])) {
	$remove_from_hopper = $_GET["remove_from_hopper"];
} elseif (isset($_POST["remove_from_hopper"])) {
	$remove_from_hopper = $_POST["remove_from_hopper"];
}
...
if (isset($_GET["custom_copy_method"])) {
	$custom_copy_method = $_GET["custom_copy_method"];
} elseif (isset($_POST["custom_copy_method"])) {
	$custom_copy_method = $_POST["custom_copy_method"];
}
...
if (isset($_GET["on_hook_agent"])) {
	$on_hook_agent = $_GET["on_hook_agent"];
} elseif (isset($_POST["on_hook_agent"])) {
	$on_hook_agent = $_POST["on_hook_agent"];
}
if (isset($_GET["delete_did"])) {
	$delete_did = $_GET["delete_did"];
} elseif (isset($_POST["delete_did"])) {
	$delete_did = $_POST["delete_did"];
}
if (isset($_GET["group_by_campaign"])) {
	$group_by_campaign = $_GET["group_by_campaign"];
} elseif (isset($_POST["group_by_campaign"])) {
	$group_by_campaign = $_POST["group_by_campaign"];
}
if (isset($_GET["source_user"])) {
	$source_user = $_GET["source_user"];
} elseif (isset($_POST["source_user"])) {
	$source_user = $_POST["source_user"];
}
if (isset($_GET["list_exists_check"])) {
	$list_exists_check = $_GET["list_exists_check"];
} elseif (isset($_POST["list_exists_check"])) {
	$list_exists_check = $_POST["list_exists_check"];
}
...
if (isset($_GET["xferconf_one"])) {
	$xferconf_one = $_GET["xferconf_one"];
} elseif (isset($_POST["xferconf_one"])) {
	$xferconf_one = $_POST["xferconf_one"];
}
if (isset($_GET["xferconf_two"])) {
	$xferconf_two = $_GET["xferconf_two"];
} elseif (isset($_POST["xferconf_two"])) {
	$xferconf_two = $_POST["xferconf_two"];
}
if (isset($_GET["xferconf_three"])) {
	$xferconf_three = $_GET["xferconf_three"];
} elseif (isset($_POST["xferconf_three"])) {
	$xferconf_three = $_POST["xferconf_three"];
}
if (isset($_GET["xferconf_four"])) {
	$xferconf_four = $_GET["xferconf_four"];
} elseif (isset($_POST["xferconf_four"])) {
	$xferconf_four = $_POST["xferconf_four"];
}
if (isset($_GET["xferconf_five"])) {
	$xferconf_five = $_GET["xferconf_five"];
} elseif (isset($_POST["xferconf_five"])) {
	$xferconf_five = $_POST["xferconf_five"];
}
if (isset($_GET["use_internal_webserver"])) {
	$use_internal_webserver = $_GET["use_internal_webserver"];
} elseif (isset($_POST["use_internal_webserver"])) {
	$use_internal_webserver = $_POST["use_internal_webserver"];
}
if (isset($_GET["field_label"])) {
	$field_label = $_GET["field_label"];
...
if (isset($_GET["field_description"])) {
	$field_description = $_GET["field_description"];
} elseif (isset($_POST["field_description"])) {
	$field_description = $_POST["field_description"];
}
if (isset($_GET["field_rank"])) {
	$field_rank = $_GET["field_rank"];
} elseif (isset($_POST["field_rank"])) {
	$field_rank = $_POST["field_rank"];
}
if (isset($_GET["field_help"])) {
	$field_help = $_GET["field_help"];
} elseif (isset($_POST["field_help"])) {
	$field_help = $_POST["field_help"];
}
if (isset($_GET["field_type"])) {
	$field_type = $_GET["field_type"];
} elseif (isset($_POST["field_type"])) {
	$field_type = $_POST["field_type"];
}
if (isset($_GET["field_options"])) {
	$field_options = $_GET["field_options"];
} elseif (isset($_POST["field_options"])) {
	$field_options = $_POST["field_options"];
}
if (isset($_GET["field_size"])) {
	$field_size = $_GET["field_size"];
} elseif (isset($_POST["field_size"])) {
	$field_size = $_POST["field_size"];
}
if (isset($_GET["field_max"])) {
	$field_max = $_GET["field_max"];
} elseif (isset($_POST["field_max"])) {
	$field_max = $_POST["field_max"];
}
if (isset($_GET["field_default"])) {
	$field_default = $_GET["field_default"];
} elseif (isset($_POST["field_default"])) {
	$field_default = $_POST["field_default"];
}
if (isset($_GET["field_required"])) {
	$field_required = $_GET["field_required"];
} elseif (isset($_POST["field_required"])) {
	$field_required = $_POST["field_required"];
}
if (isset($_GET["name_position"])) {
	$name_position = $_GET["name_position"];
} elseif (isset($_POST["name_position"])) {
	$name_position = $_POST["name_position"];
}
if (isset($_GET["multi_position"])) {
	$multi_position = $_GET["multi_position"];
} elseif (isset($_POST["multi_position"])) {
	$multi_position = $_POST["multi_position"];
}
...
if (isset($_GET["field_encrypt"])) {
	$field_encrypt = $_GET["field_encrypt"];
} elseif (isset($_POST["field_encrypt"])) {
	$field_encrypt = $_POST["field_encrypt"];
}
if (isset($_GET["field_show_hide"])) {
	$field_show_hide = $_GET["field_show_hide"];
} elseif (isset($_POST["field_show_hide"])) {
	$field_show_hide = $_POST["field_show_hide"];
}
if (isset($_GET["field_duplicate"])) {
	$field_duplicate = $_GET["field_duplicate"];
} elseif (isset($_POST["field_duplicate"])) {
	$field_duplicate = $_POST["field_duplicate"];
}
if (isset($_GET["field_rerank"])) {
	$field_rerank = $_GET["field_rerank"];
} elseif (isset($_POST["field_rerank"])) {
	$field_rerank = $_POST["field_rerank"];
}
if (isset($_GET["custom_fields_add"])) {
	$custom_fields_add = $_GET["custom_fields_add"];
} elseif (isset($_POST["custom_fields_add"])) {
	$custom_fields_add = $_POST["custom_fields_add"];
}
if (isset($_GET["custom_fields_update"])) {
	$custom_fields_update = $_GET["custom_fields_update"];
} elseif (isset($_POST["custom_fields_update"])) {
	$custom_fields_update = $_POST["custom_fields_update"];
}
if (isset($_GET["custom_fields_delete"])) {
	$custom_fields_delete = $_GET["custom_fields_delete"];
} elseif (isset($_POST["custom_fields_delete"])) {
	$custom_fields_delete = $_POST["custom_fields_delete"];
}
if (isset($_GET["dialable_count"])) {
	$dialable_count = $_GET["dialable_count"];
} elseif (isset($_POST["dialable_count"])) {
	$dialable_count = $_POST["dialable_count"];
}
if (isset($_GET["call_handle_method"])) {
	$call_handle_method = $_GET["call_handle_method"];
} elseif (isset($_POST["call_handle_method"])) {
	$call_handle_method = $_POST["call_handle_method"];
}
if (isset($_GET["agent_search_method"])) {
	$agent_search_method = $_GET["agent_search_method"];
} elseif (isset($_POST["agent_search_method"])) {
	$agent_search_method = $_POST["agent_search_method"];
}
if (isset($_GET["ingroup_rank"])) {
	$ingroup_rank = $_GET["ingroup_rank"];
} elseif (isset($_POST["ingroup_rank"])) {
	$ingroup_rank = $_POST["ingroup_rank"];
}
if (isset($_GET["ingroup_grade"])) {
	$ingroup_grade = $_GET["ingroup_grade"];
} elseif (isset($_POST["ingroup_grade"])) {
	$ingroup_grade = $_POST["ingroup_grade"];
}
if (isset($_GET["ingrp_rg_only"])) {
	$ingrp_rg_only = $_GET["ingrp_rg_only"];
} elseif (isset($_POST["ingrp_rg_only"])) {
...
if (isset($_GET["lead_ids"])) {
	$lead_ids = $_GET["lead_ids"];
} elseif (isset($_POST["lead_ids"])) {
	$lead_ids = $_POST["lead_ids"];
}
if (isset($_GET["delete_cf_data"])) {
	$delete_cf_data = $_GET["delete_cf_data"];
} elseif (isset($_POST["delete_cf_data"])) {
	$delete_cf_data = $_POST["delete_cf_data"];
}
if (isset($_GET["dispo_call_url"])) {
	$dispo_call_url = $_GET["dispo_call_url"];
} elseif (isset($_POST["dispo_call_url"])) {
	$dispo_call_url = $_POST["dispo_call_url"];
}
if (isset($_GET["entry_type"])) {
	$entry_type = $_GET["entry_type"];
} elseif (isset($_POST["entry_type"])) {
	$entry_type = $_POST["entry_type"];
}
if (isset($_GET["alt_url_id"])) {
	$alt_url_id = $_GET["alt_url_id"];
} elseif (isset($_POST["alt_url_id"])) {
	$alt_url_id = $_POST["alt_url_id"];
}
if (isset($_GET["url_address"])) {
	$url_address = $_GET["url_address"];
} elseif (isset($_POST["url_address"])) {
...
if (isset($_GET["url_rank"])) {
	$url_rank = $_GET["url_rank"];
} elseif (isset($_POST["url_rank"])) {
	$url_rank = $_POST["url_rank"];
}
if (isset($_GET["url_statuses"])) {
	$url_statuses = $_GET["url_statuses"];
} elseif (isset($_POST["url_statuses"])) {
	$url_statuses = $_POST["url_statuses"];
}
if (isset($_GET["url_description"])) {
	$url_description = $_GET["url_description"];
} elseif (isset($_POST["url_description"])) {
	$url_description = $_POST["url_description"];
}
if (isset($_GET["url_lists"])) {
	$url_lists = $_GET["url_lists"];
} elseif (isset($_POST["url_lists"])) {
	$url_lists = $_POST["url_lists"];
}
if (isset($_GET["url_call_length"])) {
	$url_call_length = $_GET["url_call_length"];
} elseif (isset($_POST["url_call_length"])) {
	$url_call_length = $_POST["url_call_length"];
}
...
if (isset($_GET["preset_number"])) {
	$preset_number = $_GET["preset_number"];
} elseif (isset($_POST["preset_number"])) {
	$preset_number = $_POST["preset_number"];
}
if (isset($_GET["preset_dtmf"])) {
	$preset_dtmf = $_GET["preset_dtmf"];
} elseif (isset($_POST["preset_dtmf"])) {
	$preset_dtmf = $_POST["preset_dtmf"];
}
if (isset($_GET["preset_hide_number"])) {
	$preset_hide_number = $_GET["preset_hide_number"];
} elseif (isset($_POST["preset_hide_number"])) {
	$preset_hide_number = $_POST["preset_hide_number"];
}
...
if (strlen($hopper_priority) < 1) {
	$hopper_priority = 0;
}
if ($hopper_priority < -99) {
	$hopper_priority = -99;
}
if ($hopper_priority > 99) {
	$hopper_priority = 99;
}
if (preg_match("/^Y$/", $remove_from_hopper)) {
	$add_to_hopper = 'N';
}
...
if (($api_list_restrict > 0) and (($function == 'add_lead') or ($function == 'update_lead') or ($function == 'batch_update_lead') or ($function == 'update_list') or ($function == 'list_info') or ($function == 'list_custom_fields') or ($function == 'lead_search'))) {
	...
	if ($ss_conf_ct > 0) {
		...
		if ($DB > 0) {
			echo "Allowed lists:|$allowed_lists|$allowed_listsSQL|\n";
		}
	} else {
		$result = 'ERROR';
...
if ($function == 'sounds_list') {
	...
	if ($DB > 0) {
		echo "DEBUG: sounds_list query - $stmt\n";
	}
	$rslt = mysql_to_mysqli($stmt, $link);
	$row = mysqli_fetch_row($rslt);
	$allowed_user = $row[0];
	if ($allowed_user < 1) {
		...
		if ($ss_conf_ct > 0) {
			...
			if (preg_match("/\//", $admin_web_directory)) {
				$admin_web_dir = dirname("$admin_web_directory");
				$admin_web_dir .= "/";
			}
		}
		##### END SETTINGS LOOKUP #####
		...
		if ($sounds_central_control_active < 1) {
			...
			$dh = opendir($dirpath);
			if ($DB > 0) {
				echo "DEBUG: sounds_list variables - $dirpath|$stage|$format\n";
			}
			...
			while (false !== ($file = readdir($dh))) {
				...
				if ((!is_dir("$dirpath/$file")) and (preg_match('/\.wav$|\.gsm$/', $file))) {
					if (file_exists("$dirpath/$file")) {
						...
						if (preg_match('/date/i', $stage)) {
							$file_sort[$i] = $file_epoch[$i] . "----------" . $i;
						}
						if (preg_match('/name/i', $stage)) {
							$file_sort[$i] = $file_names[$i] . "----------" . $i;
						}
						if (preg_match('/size/i', $stage)) {
			...
			while ($k < $i) {
				...
				if ($DB > 0) {
					echo "DEBUG: sounds_list variables - $file_sort[$k]|$size|$NOWsize|\n";
				}
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($group_exists < 1) {
				...
				$closer_campaigns_list = preg_replace("/,''/", '', $closer_campaigns_list);
				if ($DB > 0) {
					echo "DEBUG: |$campaigns_list|$campaigns_output_list|$closer_campaigns_list|\n";
				}
			}
			if (strlen($campaigns_list) < 3) {
				...
				if (strlen($closer_campaigns_list) > 2) {
					...
					if ($ignore_agentdirect == 'Y') {
						$excludeAGENTDIRECTsql = 'and group_id NOT LIKE "AGENTDIRECT%"';
					}
			...
			if ($allowed_user < 1) {
				...
				if ($L < 1) {
					...
					while ($hl_recs > $L) {
						...
						if ($DB > 0) {
							echo "GMT: $lead_offset($gmt|$SERVER_GMT)|LC: $Llast_call_epoch[$L]($StarTtime)|$last_call_age|\n";
						}
						if ($last_call_age < 24) {
...
if ($function == 'blind_monitor') {
	...
	testEcho($api_allowed_functions, '$api_allowed_functions');
	testEcho($function, '$function');
	if (strlen($source) < 2) {
		$result = 'ERROR';
		$result_reason = "Invalid Source";
		echo "$result: $result_reason - $source\n";
		...
		if (($allowed_user < 1) and ($source != 'queuemetrics')) {
			...
			if ($session_exists < 1) {
				...
				if (($phone_exists < 1) and ($source != 'queuemetrics')) {
					...
					if ($DB > 0) {
						echo "DEBUG: blind_monitor query - $stmt\n";
					}
					$rslt = mysql_to_mysqli($stmt, $link);
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if (strlen($caller_id_number) < 6) {
				...
				if (strlen($group_alias_id) < 2) {
					$group_alias_id = $caller_id_number;
				}
				if (strlen($group_alias_name) < 2) {
					$group_alias_name = $caller_id_number;
				}
				if (strlen($active) < 1) {
					$active = 'Y';
				}
				if (strlen($admin_user_group) < 1) {
					$admin_user_group = '---ALL---';
				}
				...
				if (($list_exists < 1) and ($custom_fields_add != 'Y') and ($custom_fields_update != 'Y') and ($custom_fields_delete != 'Y') and ((strlen($custom_fields_copy) < 1) or (strlen($custom_fields_copy) > 14))) {
					...
					if ($custom_fields_add == 'Y') {
						...
						if ($list_exists > 0) {
							...
							if ($DB > 0) {
								echo "$custom_fields_modify_exists|$stmt|\n";
							}
							if ($custom_fields_modify_exists < 1) {
								...
								if ($DB > 0) {
									echo "Add custom field triggered|$add_custom_fields_trigger|\n";
								}
						...
						if (($add_custom_fields_trigger > 0) and (strlen($list_id) > 1)) {
							if ((strlen($field_label) < 1) or (strlen($field_name) < 1) or (strlen($field_size) < 1) or (strlen($field_type) < 1) or (strlen($field_rank) < 1)) {
								...
								if (!preg_match("/^Y$|^N$/", $field_encrypt)) {
									$field_encrypt = 'N';
								}
								if (!preg_match("/^DISABLED$|^X_OUT_ALL$|LAST_1|LAST_2|LAST_3|LAST_4|FIRST_1_LAST_4/", $field_show_hide)) {
									$field_show_hide = 'DISABLED';
								}
								if (!preg_match("/^TOP$|^LEFT$/", $name_position)) {
									$name_position = 'LEFT';
								}
								if (!preg_match("/^HORIZONTAL$|^VERTICAL$/", $multi_position)) {
									$multi_position = 'HORIZONTAL';
								}
								if (!preg_match("/^Y$|^N$/", $field_required)) {
									$field_required = 'N';
								}
								if (!preg_match("/^Y$|^N$/", $field_duplicate)) {
									$field_duplicate = 'N';
								}
								if (!preg_match("/^YES$|^NO$/", $field_rerank)) {
									$field_rerank = 'NO';
								}
								if (strlen($field_order) < 1) {
									$field_order = '1';
								}
								$temp_webserver = (isset($_SERVER['HTTPS']) ? 's' : '') . "://$_SERVER[HTTP_HOST]";
								if ($use_internal_webserver == 'Y') {
									$temp_webserver = "://$SSsounds_web_server";
								}
								...
								if ($DB > 0) {
									echo "Add custom fields url|$url|$url_post_fields|\n";
								}
								...
								if (preg_match('/ERROR:/', $resp)) {
									$temp_response = 'ERROR: Field not added';
								}
								if (preg_match('/SUCCESS:/', $resp)) {
									$temp_response = 'SUCCESS: Field added';
								}
					...
					if ($custom_fields_update == 'Y') {
						...
						if ($list_exists > 0) {
							...
							if ($custom_fields_modify_exists < 1) {
								...
								if ($DB > 0) {
									echo "Update custom field triggered|$update_custom_fields_trigger|\n";
								}
						...
						if (($update_custom_fields_trigger > 0) and (strlen($list_id) > 1)) {
							if (strlen($field_label) < 1) {
								...
								if ($fields_to_print < 1) {
									...
									if (!preg_match("/^TOP$|^LEFT$/", $name_position)) {
										$name_position = $A_name_position;
									}
									if (!preg_match("/^HORIZONTAL$|^VERTICAL$/", $multi_position)) {
										$multi_position = $A_multi_position;
									}
									if (!preg_match("/^Y$|^N$/", $field_required)) {
										$field_required = $A_field_required;
									}
									if (!preg_match("/^Y$|^N$/", $field_duplicate)) {
										$field_duplicate = $A_field_duplicate;
									}
									if (!preg_match("/^YES$|^NO$/", $field_rerank)) {
										$field_rerank = 'NO';
									}
									if (!preg_match("/^Y$|^N$/", $field_encrypt)) {
										$field_encrypt = $A_field_encrypt;
									}
									if (!preg_match("/^DISABLED$|^X_OUT_ALL$|LAST_1|LAST_2|LAST_3|LAST_4|FIRST_1_LAST_4/", $field_show_hide)) {
										$field_show_hide = $A_field_show_hide;
									}
									if (strlen($field_name) < 1) {
										$field_name = $A_field_name;
									}
									if (strlen($field_description) < 1) {
										$field_description = $A_field_description;
									}
									if (strlen($field_rank) < 1) {
										$field_rank = $A_field_rank;
									}
									if (strlen($field_help) < 1) {
										$field_help = $A_field_help;
									}
									if (strlen($field_type) < 1) {
										$field_type = $A_field_type;
									}
									if (strlen($field_options) < 1) {
										$field_options = $A_field_options;
									}
									if (strlen($field_size) < 1) {
										$field_size = $A_field_size;
									}
									if (strlen($field_max) < 1) {
										$field_max = $A_field_max;
									}
									if (strlen($field_default) < 1) {
										$field_default = $A_field_default;
									}
									if (strlen($field_order) < 1) {
										$field_order = $A_field_order;
									}
									if ($field_description == '--BLANK--') {
										$field_description = '';
									}
									if ($field_help == '--BLANK--') {
										$field_help = '';
									...
									if ($DB > 0) {
										echo "Update custom fields url|$url|$url_post_fields|\n";
									}
									# use cURL to call the copy custom fields code
									$curl = curl_init();
									...
									$temp_response = 'NONE';
									if (preg_match('/ERROR:/', $resp)) {
										$temp_response = 'ERROR: Field not updated';
									}
									if (preg_match('/SUCCESS:/', $resp)) {
										$temp_response = 'SUCCESS: Field updated';
									}
					...
					if ($custom_fields_delete == 'Y') {
						...
						if ($list_exists > 0) {
							...
							if ($custom_fields_modify_exists < 1) {
								...
								if ($DB > 0) {
									echo "Delete custom field triggered|$delete_custom_fields_trigger|\n";
								}
						...
						if (($delete_custom_fields_trigger > 0) and (strlen($list_id) > 1)) {
							if (strlen($field_label) < 1) {
								...
								if ($fields_to_print < 1) {
									...
									if ($DB > 0) {
										echo "Delete custom fields url|$url|$url_post_fields|\n";
									}
									# use cURL to call the copy custom fields code
									$curl = curl_init();
									...
									$temp_response = 'NONE';
									if (preg_match('/ERROR:/', $resp)) {
										$temp_response = 'ERROR: Field not deleted';
									}
									if (preg_match('/SUCCESS:/', $resp)) {
										$temp_response = 'SUCCESS: Field deleted';
									}
					...
					if ((strlen($custom_fields_copy) > 1) and (strlen($custom_fields_copy) < 15)) {
						...
						if ($DB > 0) {
							echo "$custom_fields_copy_exists|$stmt|\n";
						}
						if ($custom_fields_copy_exists < 1) {
							...
							if ($DB > 0) {
								echo "$vicidial_lists_fields_exists|$stmt|\n";
							}
							if ($vicidial_lists_fields_exists < 1) {
								...
								if ($custom_fields_modify_exists < 1) {
									...
									if ($DB > 0) {
										echo "Copy custom fields triggered|$copy_custom_fields_trigger|\n";
									}
						...
						if (($copy_custom_fields_trigger > 0) and (strlen($custom_fields_copy) > 1)) {
							...
							if ($DB > 0) {
								echo "Copy custom fields url|$url|\n";
							}
							# use cURL to call the copy custom fields code
							$curl = curl_init();
							...
							$temp_response = 'NONE';
							if (preg_match('/ERROR:/', $resp)) {
								$temp_response = 'ERROR: Fields not copied';
							}
							if (preg_match('/SUCCESS:/', $resp)) {
								$temp_response = 'SUCCESS: Fields copied';
							}
				...
				if ($camp_exists < 1) {
					...
					if (strlen($updateSQL) < 3) {
						...
						if ($alt_url_id == 'NEW') {
							...
							if ($DB) {
								echo "$add_count|$new_url_id|$stmt|\n";
							}
				...
				if ($camp_exists < 1) {
					...
					if ((strlen($updateSQL) < 3) or ($action == 'DELETE')) {
						if ($action == 'DELETE') {
							...
							if ($DB) {
								echo "$del_count|$preset_name|$stmt|\n";
							}
						...
						if ($action == 'NEW') {
							...
							$add_count = mysqli_affected_rows($link);
							if ($DB) {
								echo "$add_count|$preset_name|$stmt|\n";
							}
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($search_ready < 2) {
				...
				if ($DB > 0) {
					echo "DEBUG: recording_lookup query - $rec_recs|$stmt\n";
				}
				if ($rec_recs < 1) {
					$result = 'ERROR';
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($search_ready < 2) {
				...
				$rec_recs = mysqli_num_rows($rslt);
				if ($DB > 0) {
					echo "DEBUG: did_log_export query - $rec_recs|$stmt\n";
				}
				if ($rec_recs < 1) {
					$result = 'ERROR';
					...
					while ($rec_recs > $k) {
						...
						if ($DB > 0) {
							echo "DEBUG: did_log_export query - $vcl_recs|$stmt\n";
						}
						if ($vcl_recs > 0) {
							$row = mysqli_fetch_row($rslt);
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($phones_count < 1) {
				...
				if (($type != 'IN') and ($type != 'OUT') and ($type != 'ALL')) {
					$type = 'OUT';
				}
				...
				while ($phones_count > $m) {
					...
					if ($DB > 0) {
						echo "DEBUG: $m|$phones_count|$phones_ready[$m]\n";
					}
					...
					if (($type == 'OUT') or ($type == 'ALL')) {
						...
						$rec_recs = mysqli_num_rows($rslt);
						if ($DB > 0) {
							echo "DEBUG: phone_number_log outbound query - $rec_recs|$stmt\n";
						}
						if ($rec_recs > 0) {
							$number_found++;
					...
					if (($type == 'IN') or ($type == 'ALL')) {
						...
						$rec_recs = mysqli_num_rows($rslt);
						if ($DB > 0) {
							echo "DEBUG: phone_number_log inbound query - $rec_recs|$stmt\n";
						}
						if ($rec_recs > 0) {
							$number_found++;
							if (($header == 'YES') and ($header_out < 1)) {
				...
				while ($k > $p) {
					...
					$vcl_recs = mysqli_num_rows($rslt);
					if ($DB > 0) {
						echo "DEBUG: phone_number_log list query - $vcl_recs|$stmt\n";
					}
					if ($vcl_recs > 0) {
						$row = mysqli_fetch_row($rslt);
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($search_ready < 1) {
				...
				$rec_recs = mysqli_num_rows($rslt);
				if ($DB > 0) {
					echo "DEBUG: agent_stats_export query - $rec_recs|$stmt\n";
				}
				if ($rec_recs < 1) {
					$result = 'ERROR';
					...
					while ($uc >= $k) {
						...
						$vcl_recs = mysqli_num_rows($rslt);
						if ($DB > 0) {
							echo "DEBUG: agent_stats_export query - $vcl_recs|$stmt\n";
						}
						if ($vcl_recs > 0) {
							$row = mysqli_fetch_row($rslt);
							$ASfull_name[$k] =		$row[0];
						...
						if ($login_sec > $login_start_end_check) {
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($search_ready < 1) {
				...
				$rec_recs = mysqli_num_rows($rslt);
				if ($DB > 0) {
					echo "DEBUG: user_group_status query - $rec_recs|$stmt\n";
				}
				if ($rec_recs > 0) {
					while ($rec_recs > $k) {
	...
	if (strlen($source) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($search_ready < 1) {
				...
				$rec_recs = mysqli_num_rows($rslt);
				if ($DB > 0) {
					echo "DEBUG: in_group_status query - $rec_recs|$stmt\n";
				}
				if ($rec_recs > 0) {
					while ($rec_recs > $k) {
						# user,status,campaign_id,user_group,comments,callerid,lead_id
				...
				if ($lead_exists > 0) {
					...
					if ($list_exists > 0) {
						if ($custom_fields == 'Y') {
							...
							if ($DB) {
								echo "CF user: |$LOGadmin_hide_lead_data|$LOGadmin_hide_phone_data|$LOGadmin_cf_show_hidden|\n";
							}
						...
						if ($field_exists > 0) {
							...
							if ($enc_fields > 0) {
								...
								$field_enc_all = '';
								if ($DB) {
									echo "|$field_name|$encrypt_list|$hide_list|\n";
								}
								if ((preg_match("/,$field_name,/", $encrypt_list)) and (strlen($output) > 0)) {
									if ($DB) {
										echo "DECRYPTING $field_name\n";
									}
		...
		if ($allowed_user < 1) {
			...
			if ((strlen($lead_id) < 1) and ((strlen($phone_number) < 6) or (strlen($phone_number) > 19))) {
				...
				while ($lead_exists > $lead_loop_ct) {
					...
					if ($DB) {
						echo "DEBUG: $lead_loop_ct|$lead_list_id|$lead_entry_list_id|$lead_lead_id|\n";
					}
							...
							if ($custom_fields_found > 0) {
								...
								while ($r > $rc) {
									...
									if ($enc_fields > 0) {
										...
										$field_enc_all = '';
										if ($DB) {
											echo "|$temp_CP_label|$encrypt_list|$hide_list|\n";
										}
										if ((preg_match("/,$temp_CP_label,/", $encrypt_list)) and (strlen($temp_CF_value) > 0)) {
											if ($DB) {
												echo "DECRYPTING $temp_CP_label\n";
											}
				...
				while ($leads_exist > $i) {
					...
					if ($lead_to_list > 0) {
						...
						if ((strlen($LOGallowed_campaignsSQL) > 3) and ($api_list_restrict > 0)) {
							...
							if ($allowed_list < 1) {
								if ($DB > 0) {
									echo "DEBUG: NOT AN ALLOWED LIST: $LEADlist_id|$export_lead_id[$i]\n";
								}
							}
						}
		...
		if ($modify_leads < 1) {
			...
			if (($find_lead_id < 1) and ($find_vendor_lead_code < 1) and ($find_phone_number < 1)) {
				...
				if ($find_lead_id > 0) # search for the lead_id
				{
					...
					if ($DB > 0) {
						echo "DEBUG: Checking for lead_id - $lead_id|$pc_recs|$stmt|\n";
					}
					$n = 0;
					while ($pc_recs > $n) {
						$row = mysqli_fetch_row($rslt);
				...
				if (($find_vendor_lead_code > 0) and ($search_found < 1)) # search for the vendor_lead_code
				{
					...
					$pc_recs = mysqli_num_rows($rslt);
					if ($DB > 0) {
						echo "DEBUG: Checking for vendor_lead_code - $vendor_lead_code|$pc_recs|$stmt|\n";
					}
					$n = 0;
					while ($pc_recs > $n) {
						$row = mysqli_fetch_row($rslt);
				...
				if (($find_phone_number > 0) and ($search_found < 1)) # search for the phone_number
				{
					...
					$pc_recs = mysqli_num_rows($rslt);
					if ($DB > 0) {
						echo "DEBUG: Checking for phone_number - $phone_number|$pc_recs|$stmt|\n";
					}
					$n = 0;
					while ($pc_recs > $n) {
						$row = mysqli_fetch_row($rslt);
				...
				if ($search_found > 0) {
					...
					if ($DB > 0) {
						echo "Results found, preparing output: |$search_found|$PH_search|$SK_count|\n";
					}
					$tc = 0;
					while ($tc < $PH_search) {
						$rc = 0;
...
if ($function == 'update_log_entry') {
	...
	####### query params start
	if (isset($_GET["update_agents_performance"])) {
		$update_agents_performance = $_GET["update_agents_performance"];
	} elseif (isset($_POST["update_agents_performance"])) {
		$update_agents_performance = $_POST["update_agents_performance"];
	}

	if (isset($_GET["xQuery"])) {
		$xQuery = $_GET["xQuery"];
	} elseif (isset($_POST["xQuery"])) {
		$xQuery = $_POST["xQuery"];
	}
	####### query params end
		...
		if ($allowed_user < 1) {
			...
			if ((strlen($group) < 2) or (strlen($call_id) < 8) or (strlen($status) < 8)) {
				...
				if (($inbound_call < 1) and ($outbound_call < 1)) {
					...
					################ TEST QUERY START
					if ($inbound_call > 0) {
						if ($xQuery === 'true' || $xQuery === '1') {
							$stmtQuery = "SELECT 
								vicidial_closer_log.status as closer_status, 
								vicidial_closer_log.closecallid as closer_uniqueid, 
								vicidial_agent_log.status as agent_log_status, 
								vicidial_agent_log.uniqueid as agent_log_uniqueid 
							from 
								vicidial_closer_log, 
								vicidial_agent_log 
							where 
						...
						if ($xQuery === 'true' || $xQuery === '1') {
							$stmtQuery = "SELECT
								vicidial_log.status as log_status, 
								vicidial_log.uniqueid as log_uniqueid, 
								vicidial_agent_log.status as agent_log_status, 
								vicidial_agent_log.uniqueid as agent_log_uniqueid 
								from 
								vicidial_log, 
					...
					$queryRes = mysql_to_mysqli($stmtQuery, $link);
					$records = mysqli_num_rows($queryRes);
					if ($records > 0) {
						function testEcho($v, $identifier)
						{
							if (is_array($v)) {
					...
					################ TEST UPDATE START
					if ($inbound_call > 0) {
						if ($update_agents_performance === 'true' || $update_agents_performance === '1') {
					...
					if ($update_count > 0) {
						$result = 'SUCCESS';
						if ($update_agents_performance) {
							$result_reason = "update_log_entry, vicidial_agent_log, and vicidial_log/vicidial_closer_log RECORD HAS BEEN UPDATED";
						} else {
	...
	if (strlen($source) < 2) {
		...
		if ($modify_leads < 1) {
			...
			if (preg_match("/Y/i", $list_exists_check)) {
				...
				$row = mysqli_fetch_row($rslt);
				if ($DB > 0) {
					echo "DEBUG: add_lead list_exists_check query - $row[0]|$stmt\n";
				}
			...
			if (($usacan_prefix_check == 'Y') and ($valid_number > 0)) {
				...
				if ($DB > 0) {
					echo "DEBUG: add_lead prefix check - $USprefix|$phone_number\n";
				}
				if ($USprefix < 2) {
					$valid_number = 0;
			...
			if (($usacan_areacode_check == 'Y') and ($valid_number > 0)) {
				...
				if ($DB > 0) {
					echo "DEBUG: add_lead areacode check query - $stmt\n";
				}
				$rslt = mysql_to_mysqli($stmt, $link);
				$row = mysqli_fetch_row($rslt);
				$valid_number = $row[0];
			...
			if ($valid_number < 1) {
				...
				if (($dnc_check == 'Y') or ($dnc_check == 'AREACODE')) {
					if ($DB > 0) {
						echo "DEBUG: Checking for system DNC\n";
					}
				...
				if (($campaign_dnc_check == 'Y') or ($campaign_dnc_check == 'AREACODE')) {
					if ($DB > 0) {
						echo "DEBUG: Checking for campaign DNC\n";
					}
					...
					if (strlen($use_other_campaign_dnc) > 0) {
						$temp_campaign_id = $use_other_campaign_dnc;
					}
				...
				if (preg_match("/30DAY|60DAY|90DAY|180DAY|360DAY/i", $duplicate_check)) {
					$day_val = 30;
					if (preg_match("/30DAY/i", $duplicate_check)) {
						$day_val = 30;
					}
					if (preg_match("/60DAY/i", $duplicate_check)) {
						$day_val = 60;
					}
					if (preg_match("/90DAY/i", $duplicate_check)) {
						$day_val = 90;
					}
					if (preg_match("/180DAY/i", $duplicate_check)) {
						$day_val = 180;
					}
					if (preg_match("/360DAY/i", $duplicate_check)) {
						$day_val = 360;
					}
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPLIST\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPCAMP - $duplicate_lists\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPSYS\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPTITLEALTPHONELIST\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPTITLEALTPHONECAMP\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPTITLEALTPHONESYS\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPNAMEPHONELIST\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPNAMEPHONECAMP\n";
					}
					$duplicate_found = 0;
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for duplicates - DUPNAMEPHONESYS\n";
					}
					$duplicate_found = 0;
				...
				if ($affected_rows > 0) {
					...
					if (strlen($multi_alt_phones) > 5) {
						$map = $MT;
						$ALTm_phone_code = $MT;
						$ALTm_phone_number = $MT;
						$ALTm_phone_note = $MT;
						$map = explode('!', $multi_alt_phones);
						$map_count = count($map);
						if ($DB > 0) {
							echo "DEBUG: add_lead multi-al-entry - $a|$map_count|$multi_alt_phones\n";
						}
						$g++;
						$r = 0;
						$s = 0;
						$inserted_alt_phones = 0;
						while ($r < $map_count) {
							$s++;
							$ncn = $MT;
							$ncn = explode('_', $map[$r]);
		...
		if ($modify_leads < 1) {
			...
			if (($find_lead_id < 1) and ($find_vendor_lead_code < 1) and ($find_phone_number < 1)) {
				...
				if ((preg_match("/Y/i", $list_exists_check)) and (strlen($list_id_field) > 0)) {
					...
					$row = mysqli_fetch_row($rslt);
					if ($DB > 0) {
						echo "DEBUG: update_lead list_exists_check query - $row[0]|$stmt\n";
					}
					$list_exists_count = $row[0];
					if ($list_exists_count < 1) {
						$result = 'ERROR';
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for lead_id - $lead_id\n";
					}
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for vendor_lead_code - $vendor_lead_code\n";
					}
				...
				{
					if ($DB > 0) {
						echo "DEBUG: Checking for phone_number - $phone_number\n";
					}
				...
				if ($no_update == 'Y') {
					if ($search_found > 0) {
						if (strlen($lead_id) < 1) {
							$lead_id = $search_lead_id[0];
						}
						if (strlen($list_id) < 1) {
							$list_id = $search_lead_list[0];
						}
						$result = 'NOTICE';
					...
					if ($search_found > 0) {
						...
						if (strlen($user_field) > 0) {
							$VL_update_SQL .= "user=\"$user_field\",";
						}
						if (strlen($list_id_field) > 0) {
							$VL_update_SQL .= "list_id=\"$list_id_field\",";
						}
						if (strlen($status) > 0) {
							$VL_update_SQL .= "status=\"$status\",";
						}
						if (strlen($vendor_lead_code) > 0) {
							$VL_update_SQL .= "vendor_lead_code=\"$vendor_lead_code\",";
						}
						if (strlen($source_id) > 0) {
							$VL_update_SQL .= "source_id=\"$source_id\",";
						}
						if (strlen($gmt_offset_now) > 0) {
							$VL_update_SQL .= "gmt_offset_now=\"$gmt_offset_now\",";
						}
						if (strlen($title) > 0) {
							$VL_update_SQL .= "title=\"$title\",";
						}
						if (strlen($first_name) > 0) {
							$VL_update_SQL .= "first_name=\"$first_name\",";
						}
						if (strlen($middle_initial) > 0) {
							$VL_update_SQL .= "middle_initial=\"$middle_initial\",";
						}
						if (strlen($last_name) > 0) {
							$VL_update_SQL .= "last_name=\"$last_name\",";
						}
						if (strlen($address1) > 0) {
							$VL_update_SQL .= "address1=\"$address1\",";
						}
						if (strlen($address2) > 0) {
							$VL_update_SQL .= "address2=\"$address2\",";
						}
						if (strlen($address3) > 0) {
							$VL_update_SQL .= "address3=\"$address3\",";
						}
						if (strlen($city) > 0) {
							$VL_update_SQL .= "city=\"$city\",";
						}
						if (strlen($state) > 0) {
							$VL_update_SQL .= "state=\"$state\",";
						}
						if (strlen($province) > 0) {
							$VL_update_SQL .= "province=\"$province\",";
						}
						if (strlen($postal_code) > 0) {
							$VL_update_SQL .= "postal_code=\"$postal_code\",";
						}
						if (strlen($country_code) > 0) {
							$VL_update_SQL .= "country_code=\"$country_code\",";
						}
						if (strlen($gender) > 0) {
							$VL_update_SQL .= "gender=\"$gender\",";
						}
						if (strlen($date_of_birth) > 0) {
							$VL_update_SQL .= "date_of_birth=\"$date_of_birth\",";
						}
						if (strlen($alt_phone) > 0) {
							$VL_update_SQL .= "alt_phone=\"$alt_phone\",";
						}
						if (strlen($email) > 0) {
							$VL_update_SQL .= "email=\"$email\",";
						}
						if (strlen($security_phrase) > 0) {
							$VL_update_SQL .= "security_phrase=\"$security_phrase\",";
						}
						if (strlen($comments) > 0) {
							$VL_update_SQL .= "comments=\"$comments\",";
						}
						if (strlen($rank) > 0) {
							$VL_update_SQL .= "rank=\"$rank\",";
						}
						if (strlen($owner) > 0) {
							$VL_update_SQL .= "owner=\"$owner\",";
						}
						if (strlen($called_count) > 0) {
							$VL_update_SQL .= "called_count=\"$called_count\",";
						}
						if (strlen($phone_code) > 0) {
							$VL_update_SQL .= "phone_code=\"$phone_code\",";
						}
						if ((strlen($reset_lead) > 0 && $reset_lead == 'Y')) {
							$VL_update_SQL .= "called_since_last_reset='N',";
						}
						if ((strlen($update_phone_number) > 0 && $update_phone_number == 'Y' && strlen($phone_number) > 0)) {
							$VL_update_SQL .= "phone_number='$phone_number',";
						}
						if ((strlen($entry_list_id) > 0) and ($custom_fields != 'Y')) {
							$VL_update_SQL .= "entry_list_id=\"$entry_list_id\",";
						}
						...
						while ($search_found > $n) {
							...
							if ($custom_fields == 'Y') {
								...
								if ($search_entry_list[$n] > 99) {
									$lead_custom_list = $search_entry_list[$n];
								}
								$update_sent = 0;
								$CFoutput = '';
							...
							if ((strlen($phone_number) < 6) or (strlen($phone_number) > 18) or (strlen($phone_code) < 1) or (strlen($list_id) < 3)) {
								...
								if ($affected_rows > 0) {
									...
									if (strlen($multi_alt_phones) > 5) {
										...
										$map_count = count($map);
										if ($DB > 0) {
											echo "DEBUG: update_lead multi-al-entry - $a|$map_count|$multi_alt_phones\n";
										}
										$g++;
										$r = 0;
										$s = 0;
	...
	if (strlen($source) < 2) {
		...
		if ($modify_leads < 1) {
			...
			if ((preg_match("/Y/i", $list_exists_check)) and (strlen($list_id_field) > 0)) {
				...
				$row = mysqli_fetch_row($rslt);
				if ($DB > 0) {
					echo "DEBUG: batch_update_lead list_exists_check query - $row[0]|$stmt\n";
				}
				$list_exists_count = $row[0];
				if ($list_exists_count < 1) {
					$result = 'ERROR';
			...
			if (strlen($lead_ids) > 0) # search for the lead_id
			{
				...
				if ($DB > 0) {
					echo "DEBUG: Checking for lead_ids - $lead_ids |$stmt|\n";
				}
				$rslt = mysql_to_mysqli($stmt, $link);
				$pc_recs = mysqli_num_rows($rslt);
				$n = 0;
			...
			if (($search_found > 0) and (strlen($found_lead_ids) > 0)) {
				...
				if (strlen($VL_update_SQL) > 6) {
					...
					if ($DB > 0) {
						echo "DEBUG: batch_update_lead query - $stmt\n";
					}
					$rslt = mysql_to_mysqli($stmt, $link);
					$VLaffected_rows = mysqli_affected_rows($link);
		...
		if ($allowed_check < 1) {
			...
			if ($valid_call_time < 1) {
				...
				if (($usacan_prefix_check == 'Y') and ($valid_number > 0)) {
					$USprefix = 	substr($phone_number, 3, 1);
					if ($DB > 0) {
						echo "DEBUG: check_phone_number prefix check - $USprefix|$phone_number\n";
					}
					if ($USprefix < 2) {
						$valid_number = 0;
				...
				if (($usacan_areacode_check == 'Y') and ($valid_number > 0)) {
					...
					$stmt = "select count(*) from vicidial_phone_codes where areacode='$phone_areacode' and country_code='1';";
					if ($DB > 0) {
						echo "DEBUG: check_phone_number areacode check query - $stmt\n";
					}
					$rslt = mysql_to_mysqli($stmt, $link);
					$row = mysqli_fetch_row($rslt);
					$valid_number = $row[0];
				...
				if ($valid_number < 1) {
					...
					if (($dnc_check == 'Y') or ($dnc_check == 'AREACODE')) {
						...
						if ($DB > 0) {
							echo "DEBUG: check_phone_number query - $stmt\n";
						}
						$rslt = mysql_to_mysqli($stmt, $link);
						$row = mysqli_fetch_row($rslt);
						$dnc_found = $row[0];
...
if ($function == 'call_dispo_report') {
	if (strlen($campaigns) < 2 && strlen($ingroups) < 2 && strlen($did_ids) < 1 && strlen($did_patterns) < 2) {
		...
		if ($allowed_user < 1) {
			...
			if ($show_percentages && !$status_breakdown) {
				$show_percentages = "";
			}
...
function lookup_gmt_api($phone_code, $USarea, $state, $LOCAL_GMT_OFF_STD, $Shour, $Smin, $Ssec, $Smon, $Smday, $Syear, $tz_method, $postal_code, $owner, $USprefix)
{
	...
	if ((!$AC_processed) and ($dst_range == 'SSM-FSN')) {
		if ($DBX) {
			print "     Second Sunday March to First Sunday November\n";
		}
		#**********************************************************************
		# SSM-FSN
	...
	if ((!$AC_processed) and ($dst_range == 'FSA-LSO')) {
		if ($DBX) {
			print "     First Sunday April to Last Sunday October\n";
		}
		#**********************************************************************
		# FSA-LSO
		#     This is returns 1 if Daylight Savings Time is in effect and 0 if 
	...
	if ((!$AC_processed) and ($dst_range == 'LSM-LSO')) {
		if ($DBX) {
			print "     Last Sunday March to Last Sunday October\n";
		}
		#**********************************************************************
	...
	if ((!$AC_processed) and ($dst_range == 'LSO-LSM')) {
		if ($DBX) {
			print "     Last Sunday October to Last Sunday March\n";
		}
		#**********************************************************************
		#     This is s 1 if Daylight Savings Time is in effect and 0 if 
		#       Standard time is in effect.
	...
	if ((!$AC_processed) and ($dst_range == 'FSO-LSM')) {
		if ($DBX) {
			print "     First Sunday October to Last Sunday March\n";
		}
		#**********************************************************************
		#   TASMANIA ONLY
		#     This is s 1 if Daylight Savings Time is in effect and 0 if 
	...
	if ((!$AC_processed) and ($dst_range == 'FSO-FSA')) {
		if ($DBX) {
			print "     Sunday in October to First Sunday in April\n";
		}
		#**********************************************************************
		# FSO-FSA
	...
	if ((!$AC_processed) and ($dst_range == 'FSO-TSM')) {
		if ($DBX) {
			print "     First Sunday October to Third Sunday March\n";
		}
		#**********************************************************************
		#     This is s 1 if Daylight Savings Time is in effect and 0 if 
		#       Standard time is in effect.
	...
	if ((!$AC_processed) and ($dst_range == 'LSS-FSA')) {
		if ($DBX) {
			print "     Last Sunday in September to First Sunday in April\n";
		}
		#**********************************************************************
		# LSS-FSA
	...
	if ((!$AC_processed) and ($dst_range == 'TSO-LSF')) {
		if ($DBX) {
			print "     Third Sunday October to Last Sunday February\n";
		}
		#**********************************************************************
		# TSO-LSF
		#     This is returns 1 if Daylight Savings Time is in effect and 0 if 
