...
# main page display
if (
	($copy_submit != _QXZ("copy")) && ($confirm_copy != _QXZ("confirm")) && ($move_submit != _QXZ("move")) && ($update_submit != _QXZ("update")) && ($delete_submit != _QXZ("delete")) && ($reset_called_count_submit != _QXZ("reset called count")) && ($callback_submit != _QXZ("switchcallbacks")) &&
